/*
    iii. Tạo class EmployeeDAO, bao gồm các methods : 
            1. public int insert (Employee emp):        
               • thêm đối tượng nhân viên emp vô bảng tbNhanVien
               • trả về số nguyên dương nếu tác vụ thành công, ngược lại trả về giá trị âm
            2. public int update (Employee emp): • thay đổi thông tin của đối tượng nhân viên emp trong bảng tbNhanVien
               • trả về số nguyên dương nếu tác vụ thành công, ngược lại trả về giá trị âm
            3. public int delete (String eID): • Xóa đối tượng nhân viên có mã số eID trong bảng tbNhanVien
               • trả về số nguyên dương nếu tác vụ thành công, ngược lại trả về giá trị âm
            4. public List<Employee> getList() , trả về danh sách nhân viên trong bảng tbNhanVien.
            5. public List<Employee> getList (String eName), trả về danh sách nhân viên trong bảng tbNhanVien có tên chứa nội dung của biến eName
 */
package model;
...
public class EmployeeDAO {
    public static int insert(Employee emp){
        ...
        try{
           ...
           String sql="insert tbNhanVien values(?,?,?,?)";
    ...
    public static int delete(String eID){
        ...
        try{
           ...
           String sql="delete from tbNhanVien where id like ?";
           PreparedStatement pst=cn.prepareStatement(sql);
    ...
    public static int update(Employee emp){
        ...
        try{
           ...
           String sql="update tbNhanVien set hoten=?,gioitinh=?,luong=? where id=?";
           PreparedStatement pst=cn.prepareStatement(sql);
